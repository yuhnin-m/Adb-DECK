...
interface AppUpdateInstaller {
    ...
    /**
     * Предварительная проверка возможности in-app установки (права/окружение).
     *
     * Должна выбрасывать исключение, если обновление невозможно запустить безопасно.
     */
    suspend fun preflightInstall(downloadUrl: String)
